...
import Controller.FilterSystem.IgualFilter;
import Controller.FilterSystem.JobPositionFilter;
import Controller.FilterSystem.ListPropertyFilter;
...
public class CreateFilterFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Element Equal Filter", "Job Position Filter", "List Property Filter" }));
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Element Equal Filter", "Job Position Filter", "List Property Filter" }));
    ...
    /*
     *  Se setean el frame a donde se configurara el filtro componente del
     *  filtro compuesto a crear(con sus listas). Con ello, tambien se seteara el tipo de 
     *  filtro que se incluira, y tambien setear este panel como panel de
     *  regreso.
     */
    ...
    /*
     * Se chequea que filtro se está creado, para posteriormente realizar su creación e 
     * incorporarlo a la tarea o a su filtro compuesto.
     */    
        ...
        if((this.getFilterType().equals("ListPropertyFilter"))||(this.getFilterType().equals("List Property Filter"))){
            ...
            if((this.getFilterType().equals("ValueFilter"))||(this.getFilterType().equals("Job Position Filter"))){
                ...
                if(this.getFilterType().equals("AndFilter")){
                    if((this.getFilterFrameI() != null)&&(this.getFilterFrameII() != null))
                        filter = new AndFilter(this.getFilterFrameI(), this.getFilterFrameII()); 
                }else{
                    if(this.jComboBox1.getSelectedItem() != null)
                        filter = new IgualFilter(this.getElement((String)this.jComboBox1.getSelectedItem()));                    
                }
            }        
        }
        if(filter == null){
    ...
    private Resource getElement(String id){
        for (int i = 0; i < this.getMainResourcesList().size(); i++) {
            if (((Resource)this.getMainResourcesList().elementAt(i)).getResId().equals(this.jComboBox1.getSelectedItem())) {
    ...
    private Resource getResource(String id){
        for (int i = 0; i < this.getResourcesList().size(); i++) {
            if (this.getResourcesList().elementAt(i).getResId().equals(this.jComboBox3.getSelectedItem())) {
    ...
    public void fillObjectCombobox(){
       ...
       for(int i = 0; i < this.getMainResourcesList().size();i++){
            this.jComboBox1.addItem(((Resource)this.getMainResourcesList().elementAt(i)).getResId());
        } 
    }
    ...
    public void fillResourceCombobox(){
       ...
       for(int i = 0; i < this.getResourcesList().size();i++){
            this.jComboBox3.addItem(((Resource)this.getResourcesList().elementAt(i)).getResId());
        } 
    }
    ...
    private CreateTaskFrame taskFrame;//Panel de vuelta, una vez creado el filtro
    //private CreateFilterFrame filterFrame;//Variable que representa esta ventana, para que otros puedan trabajar en ella
    private CreateFilterFrame filterBackFrame;//Panel de vuelta, una vez creado el filtro
    private UpdaterFrame updaterFrame;//Panel de vuelta, una vez creado el filtro
