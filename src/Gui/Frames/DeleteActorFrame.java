...
public class DeleteActorFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Delete Actor", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Verdana", 1, 11))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        for (int i = 0; i < this.getActorsList().size(); i++) {
            System.out.println("Id lista: " + this.getActorsList().elementAt(i).getResId() + "Id Combo" + this.jComboBox1.getSelectedItem() );
            if (this.getActorsList().elementAt(i).getResId().equals(this.jComboBox1.getSelectedItem())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteArtifactFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
