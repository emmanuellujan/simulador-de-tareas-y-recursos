...
public class SimulatorFrame extends javax.swing.JFrame {
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        if (seleccion == JFileChooser.APPROVE_OPTION){   
            ...
            this.getSchedulingSystem().loadData(fileChooser.getSelectedFile().getAbsolutePath() + "\\"); 
            this.setLoadState();
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        if (seleccion == JFileChooser.APPROVE_OPTION){
            ...
            NewsFrame.getInstance().setLabel("Project title is empty, please complete it.");
            NewsFrame.getInstance().setBackFrame("SimulatorFrame");
            this.setVisible(false);
            NewsFrame.getInstance().setLocationRelativeTo(null);
            NewsFrame.getInstance().setVisible(true);
                ...
                if(!this.getLoadState())
                    this.getSchedulingSystem().saveData(this.getProjectName(),fileChooser.getSelectedFile().getAbsolutePath() + "\\" );
                else
                    this.getSchedulingSystem().saveData(fileChooser.getSelectedFile().getAbsolutePath());                        
            }
        }        
