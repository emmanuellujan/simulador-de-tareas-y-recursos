...
public class SimulatorFrame extends javax.swing.JFrame {
	...
	private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton11ActionPerformed
		RelationFrame.getInstance().setResourcesList(
	...
	private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton12ActionPerformed
		...
		if (seleccion == JFileChooser.APPROVE_OPTION) {
			if (this.jTextField1.getText().equals("")
					&& (this.getSchedulingSystem().getIoSystem()
							.getConfigurator().getProjectName().equals(""))) {
			...
			if (this.jComboBox3.getSelectedItem().equals(
				...
				for (int r = 0; r < this.getNewsList().size(); r++) {
					if (this.getNewsList().elementAt(r).getTaskId()
							.equals((String) this.jComboBox3.getSelectedItem())) {
	...
	public void setMainResourcesList() {
		Vector<Resource> resourcesCurrentList = (Vector<Resource>) this.actorsList.clone();
		if (this.resourcesList != null)
			resourcesCurrentList.addAll( (Vector<Resource>) this.resourcesList.clone());
