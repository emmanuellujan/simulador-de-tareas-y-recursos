...
public class RelationFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Set Relation", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Verdana", 1, 11))); // NOI18N
        ...
        jPanel14.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Current Relations", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Verdana", 1, 11))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if((this.jComboBox1.getSelectedItem() != null)&&(this.jComboBox2.getSelectedItem()!= null)){
            if(!this.jComboBox1.getSelectedItem().equals(this.jComboBox2.getSelectedItem())){
                ...
                ErrorFrame.getInstance().setLabel("Both values are the same, must be different.");
                ErrorFrame.getInstance().setVisible(true);
            }
        }else{
            ErrorFrame.getInstance().setLabel("Empty fields.");
            ErrorFrame.getInstance().setVisible(true);
        }
    ...
    private void insertUpdateResource(Resource updatedResource){
        for(int i = 0; i < SimulatorFrame.getInstance().getActorsList().size();i++){
            if(updatedResource.getResId().equals(SimulatorFrame.getInstance().getActorsList().elementAt(i).getResId())){
                SimulatorFrame.getInstance().getActorsList().setElementAt((Actor)updatedResource, i);
            }                
        }
        for(int i = 0; i < SimulatorFrame.getInstance().getResourcesList().size();i++){
            if(updatedResource.getResId().equals(SimulatorFrame.getInstance().getResourcesList().elementAt(i).getResId())){
                SimulatorFrame.getInstance().getResourcesList().setElementAt(updatedResource, i);
            }                
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelationFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void setComboboxesValues(){
        ...
        if(this.getMainResourcesList() != null){
            for(int i = 0; i < this.getMainResourcesList().size();i++){
                this.jComboBox1.addItem(this.getMainResourcesList().elementAt(i).getResId());
                this.jComboBox2.addItem(this.getMainResourcesList().elementAt(i).getResId());
            } 
        }
    }
